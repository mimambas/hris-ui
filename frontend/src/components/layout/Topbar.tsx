  ...
  return (
    <header className="h-16 bg-canvas/95 backdrop-blur-sm border-b border-hairline flex items-center justify-between px-5 lg:px-8 sticky top-0 z-[100]">
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={() => router.push('/guide')} className="relative min-h-11 min-w-11 p-2.5 rounded-full hover:bg-primary-surface transition-colors" aria-label="Open user guide"><BookOpen size={18} className="text-body" /></button>
