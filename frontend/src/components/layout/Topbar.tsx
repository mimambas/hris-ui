...
import { Search, Bell, Menu, X, ArrowUpRight, Users, Wallet, CalendarDays, FileText, Settings, Clock } from 'lucide-react';
  ...
  return (
    <header className="h-16 bg-canvas/95 backdrop-blur-sm border-b border-hairline flex items-center justify-between px-5 lg:px-8 sticky top-0 z-20">
      <div className="flex items-center gap-3 w-full max-w-md">
        <button className="lg:hidden p-2 -ml-2 rounded-lg hover:bg-primary-surface transition-colors" aria-label="Open navigation"><Menu size={20} className="text-body" /></button>
