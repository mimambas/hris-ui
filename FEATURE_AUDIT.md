...
| Atomic transactions | partial | leave/onboarding/payroll routes | Payroll process, offboarding completion, dan leave approval + balance RPC sudah atomic; onboarding create/task workflow masih perlu RPC |
